...
<body class="padTop53 " >
            ...
            <td>
            <?php echo " 
            <a href='ver_hojadevida.php?id=".$id."&ficha=".$ficha."&rol=".$rol."'><button class='btn' name='listado_aprendices' type='submit'><i class='icon-eye-open'></i></button></a>" ?>  
            </td>
            </td>
...
<td>
                          ...
                          <?php
                $orden="SELECT comentarios FROM tab_p_aprendiz WHERE id_usuario=$id"; // Realizando una consulta SQL
...
if (isset($_POST['guardar'])){
    $sql="UPDATE tab_p_aprendiz SET comentarios='$_REQUEST[comentario_calidad]' WHERE id_usuario=$id"; 
