        ...
        <div class="media user-media well-small">
               <br>
                ...
                include("conectar.php");
                      ...
                      $sql= "SELECT COUNT (id_rol) AS ROLES FROM tab_usuario_perfil WHERE id_usuario=$id_usuario and id_rol=3";
     ...
     <a href='ver_portafolio_aprendiz.php?identificacion=".$reg['id_usuario']
        ...
        <div id="right">
            <div class="well well-small">
                ...
                <form action="seguimiento_tramites.php"><button class="btn btn-primary btn-block">SEGUIM. TRÁMITE</button></form><br>
