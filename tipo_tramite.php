 ...
 <div class="container">
   ...
   <!-- PAGE CONTENT --> 
      ...
      <tr>
        ...
        <td><input type='text' class="form-control" placeholder='Nuevo tipo de trámite' size='50' name='nom_tramite'></td>
        <td><input type='submit' name='guardar' value='GUARDAR' class="btn text-muted text-center btn-success">
        </td></form></tr></table><hr>
        <?php
          if (isset($_POST['guardar'])){
          include('conectar.php');
          $sql="INSERT INTO tab_tipo_tramite (nom_tramite) values('$_REQUEST[nom_tramite]');"; 
          ...
          ?> 
                      ...
                      $consulta = "SELECT id_tipo_tramite, nom_tramite FROM tab_tipo_tramite";//Muestra la tabla
                      ...
                      echo "<tr class='odd gradeX'><td>".$fila['id_tipo_tramite']."</td>
                                                   <td>".$fila['nom_tramite']."</td>
                      		<td align='center'>
                      		<a href='eliminar_tipo_tramite.php?id_tipo_tramite=".$fila['id_tipo_tramite']
		  					."&nom_tramite=".$fila['nom_tramite']."'>
		  					<button type='submit'><img src='assets/img/eliminar.png' alt='x' /></button>
		  					</a></td>
		  					<td align='center'><a href='actualizar_tipo_tramite.php?id_tipo_tramite=".$fila['id_tipo_tramite']."&nom_tramite=".$fila['nom_tramite']."'>
