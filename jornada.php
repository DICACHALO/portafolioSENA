 ...
 <div class="container">
   ...
   <!-- PAGE CONTENT --> 
      ...
      <tr>
        ...
        <td><input type='text' class="form-control" placeholder='Nueva jornada' size='50' name='nom_jornada'></td>
        <td><input type='submit' name='guardar' value='GUARDAR' class="btn text-muted text-center btn-success">
        </td></form></tr></table><hr>
        <?php
          if (isset($_POST['guardar'])){
          include('conectar.php');
          $sql="INSERT INTO tab_jornada (nom_jornada) values('$_REQUEST[nom_jornada]');"; 
          //Consulta para insertar la nueva información
          $respuesta=pg_query($sql) or die('Error. Intente de nuevo'.pg_last_error());
          echo "<meta http-equiv='REFRESH' content='0;url=jornada.php'>";
          pg_close($con);
          } 
          ?> 
                      ...
                      $consulta = "SELECT id_jornada, nom_jornada FROM tab_jornada";//Muestra la tabla

                      $resultado = pg_query($consulta)or die ('Error. Intente de nuevo'. pg_last_error());
                      
                      echo "
                        <table class='table table-striped table-bordered table-hover' id='dataTables-example'>
                        <caption>Tipo de trámite</caption>
                        <thead>
                        <tr >
                        <th>N°</th>
                      ...
                      echo "<tr class='odd gradeX'><td>".$fila['id_jornada']."</td>
                                                   <td>".$fila['nom_jornada']."</td>
                      		<td align='center'>
                      		<a href='eliminar_jornada.php?id_jornada=".$fila['id_jornada']
		  					."&nom_jornada=".$fila['nom_jornada']."'>
		  					<button type='submit'><img src='assets/img/eliminar.png' alt='x' /></button>
		  					</a></td>
		  					<td align='center'><a href='actualizar_jornada.php?id_jornada=".$fila['id_jornada']."&nom_jornada=".$fila['nom_jornada']."'>
